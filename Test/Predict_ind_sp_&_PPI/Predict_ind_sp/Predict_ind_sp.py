...
def test_ind_sp_ondata(dataset, test_data_name):
    ...
    ######################################################################
    ## Import model 
    deep_path1 = r"Test\Predict_ind_sp_&_PPI\Trained_model\model"
    ...
    Testing_model_PPI_Pred(val_data=val_data1, w2v_path=w2v_path, deep_path=deep_path1,data_name=test_data_name)
