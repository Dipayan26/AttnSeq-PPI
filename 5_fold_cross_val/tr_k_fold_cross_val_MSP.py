...
#########################  IMPORT Multi species DATASET ###################################
PN = pd.read_csv( r"Datasets_&_w2v_models\MSD\sequence_1.5k\MSD_1.5k.csv")

PN0 = PN['col1']
PN1 = PN['col2']
interaction = PN['interaction']
####################  IMPORT W2V_MODEL multi  species  ###########################################################################
w2v_path = r"Datasets_&_w2v_models\MSD\w2v_MSP\AA_model.pt"
###################################################################################################################
...
for  train1, test1 in kf.split(PN0, interaction):
    ...
    def k_fold_crossval_model(train_data, val_data, w2v_path):
        print("5 fold cross validation on multi species dataset............", flush = True)
