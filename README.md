...
The framework achieves 99 % accuracy on Human and Multi‑Species datasets, outperforming 15 state‑of‑the‑art baselines while retaining fast inference suitable for high‑throughput screening.